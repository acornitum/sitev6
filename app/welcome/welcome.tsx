...
export function Welcome() {
  return (
    <main className="">
      ...
      <img src="/bg.png" className="bg-center absolute opacity-20"
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="m-5 max-w-3xl flex flex-col">
          ...
          <div className="border-3 border-white bg-gray-950/85  rounded-sm p-4 max-w-xl space-y-3 mt-4 relative">
            ...
            <p>i currently run programs + events @ hack club! i’m also a first year student @ university of waterloo.</p>
...
export async function getLatestCommit() {
  const res = await octokit.request(
    "GET /repos/acornitum/sitev6/commits?sha=main&per_page=1",
    {
      headers: {
